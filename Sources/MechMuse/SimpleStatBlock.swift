...
public extension SimpleStatBlock {
    ...
    func toStatBlock() -> StatBlock {
        var result = StatBlock(
            ...
            subtype: subtype?.nonEmptyString,
            ...
            initiative: nil,
            damageVulnerabilities: damageVulnerabilities?.nonEmptyString,
            damageResistances: damageResistances?.nonEmptyString,
            damageImmunities: damageImmunities?.nonEmptyString,
            conditionImmunities: conditionImmunities?.nonEmptyString,
            senses: senses?.nonEmptyString,
            languages: languages?.nonEmptyString,
