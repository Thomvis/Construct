...
extension Monster: HasParseableVisitor {
    public static let parseableVisitor: ParseableVisitor<Monster> = .combine(
        StatBlock.parseableVisitor.pullback(state: \.stats, action: CasePath.`self`)
    )
}

extension Character: HasParseableVisitor {
    public static let parseableVisitor: ParseableVisitor<Character> = .combine(
        StatBlock.parseableVisitor.pullback(state: \.stats, action: CasePath.`self`)
    )
}

extension Spell: HasParseableVisitor {
    public static let parseableVisitor: ParseableVisitor<Spell> = ParseableVisitor { spell in
